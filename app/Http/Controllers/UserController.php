...
class UserController extends Controller
{
    ...
    public $permisos = [
        'ADMINISTRADOR' => [
            ...
            "orden_generadas.consultar_ot_canva",
            "orden_generadas.consultar_ot_timeline",
            ...
            "reportes.historial_fallas",
            "reportes.seguimiento_costos",
            "reportes.informe_general",
            "reportes.informe_ot_correctivas",
            "reportes.resumen_ots",
            "reportes.grafico_ots",
        ],
        "GERENTE" => [
            'reportes.kardex_herramientas',
            'reportes.informacion_herramientas',
