        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>
                            Reportes - Informe de Solicitudes de Herramientas
                        </h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="error invalid-feedback"
                                                    v-if="errors.herramienta"
                                                    v-text="
                                                        errors.herramienta[0]
                                                    "
                                                ></span>
                                            </div>
                                            <!-- <div
...
export default {
    data() {
        return {
            ...
            listFiltro: [
                ...
                { id: "ot", label: "Número de OT" },
                { id: "equipo", label: "Equipo" },
                { id: "herramienta", label: "Nombre de Herramienta" },
            ],
            listOTs: [],
            listEquipos: [],
            listHerramientas: [],
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post(
                    "/admin/reportes/informe_solicitudes",
                    this.oReporte,
                    config
                )
                .then((res) => {
