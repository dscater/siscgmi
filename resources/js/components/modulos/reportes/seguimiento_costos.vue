    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reportes - Seguimiento de Costos</h1>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            >
                                                ...
                                                >
                                                    <el-option
                                                        v-for="item in listTipoMantenimiento"
                                                        :key="item"
                                                        :value="item"
                                                        :label="item"
                                                    >
...
export default {
    data() {
        return {
            ...
            listFiltro: [
                ...
                { id: "tipo_mantenimiento", label: "Tipo de Mantenimiento" },
            ],
            listEquipos: [],
            listAnios: [],
            listMeses: [
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post(
                    "/admin/reportes/seguimiento_costos",
                    this.oReporte,
                    config
                )
                .then((res) => {
