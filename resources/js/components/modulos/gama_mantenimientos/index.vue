        ...
        getGamaMantenimientos() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.listRegistros = res.data.gama_mantenimientos;
                    this.totalRows = res.data.total;
                });
        },
        eliminaGamaMantenimiento(id, descripcion) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/admin/gama_mantenimientos/" + id, {
                            _method: "DELETE",
                        })
                        .then((res) => {
                            this.getGamaMantenimientos();
